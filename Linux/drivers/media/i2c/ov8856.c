...
static const struct ov8856_lane_cfg lane_cfg_2 = {
    ...
    {{.reg_list = {
     ...
     {.reg_list = {
          .num_of_regs = ARRAY_SIZE(mipi_data_rate_lane_2.regs_1),
    ...
    {{
         ...
         .vts_min = 2488,
         .reg_list = {
             .num_of_regs = ARRAY_SIZE(lane_2_mode_3280x2464),
     ...
     },
     {
         ...
         .vts_min = 1514,
         .reg_list = {
             .num_of_regs = ARRAY_SIZE(lane_2_mode_1640x1232),
...
static const struct ov8856_lane_cfg lane_cfg_4 = {
    ...
    {{.reg_list = {
     ...
     {.reg_list = {
          .num_of_regs = ARRAY_SIZE(mipi_data_rate_lane_4.regs_1),
    ...
    {{
         ...
         .vts_min = 2488,
         .reg_list = {
             .num_of_regs = ARRAY_SIZE(lane_4_mode_3280x2464),
     ...
     },
     {
         ...
         .vts_min = 1256,
         .reg_list = {
             .num_of_regs = ARRAY_SIZE(lane_4_mode_1640x1232),
     ...
     },
     {
         ...
         .vts_min = 2482,
         .reg_list = {
             .num_of_regs = ARRAY_SIZE(lane_4_mode_3264x2448),
     ...
     },
     {
         ...
         .vts_min = 2482,
         .reg_list = {
             .num_of_regs = ARRAY_SIZE(lane_4_mode_1632x1224),
...
static int ov8856_set_ctrl_hflip(struct ov8856 *ov8856, u32 ctrl_val)
{
    ...
    ret = ov8856_write_reg(ov8856, OV8856_REG_MIRROR_OPT_1,
                           ...
                           ctrl_val ? val & ~OV8856_REG_MIRROR_OP_2 : val | OV8856_REG_MIRROR_OP_2);
...
static int ov8856_set_ctrl_vflip(struct ov8856 *ov8856, u8 ctrl_val)
{
    ...
    ret = ov8856_write_reg(ov8856, OV8856_REG_FLIP_OPT_2,
                           OV8856_REG_VALUE_08BIT,
                           ctrl_val ? val | OV8856_REG_FLIP_OP_2 : val & ~OV8856_REG_FLIP_OP_2);
...
static int ov8856_init_controls(struct ov8856 *ov8856)
{
    ...
    ov8856->link_freq = v4l2_ctrl_new_int_menu(ctrl_hdlr, &ov8856_ctrl_ops,
                                               V4L2_CID_LINK_FREQ,
                                               ARRAY_SIZE(ov8856->priv_lane->link_freq_menu_items) - 1,
...
static int ov8856_identify_module(struct ov8856 *ov8856)
{
    ...
    dev_info(&client->dev, "OV8856 revision %x (%s) at address 0x%02x\n",
             val,
             val == OV8856_2A_MODULE ? "2A" : val == OV8856_1B_MODULE ? "1B"
                                                                      : "unknown revision",
             client->addr);
